...
// ذخیره کردن اطلاعات به فایل .env
...
// تولید داده‌های جدید برای کیف پول
...
func GenerateURL(walletAddress, body, initCode, initData string) string {
	// برای نمونه، فرض کنیم که شما نیاز به ترکیب این مقادیر در URL دارید
